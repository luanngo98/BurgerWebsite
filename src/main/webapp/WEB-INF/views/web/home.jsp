...
<body>
    ...
    <div class="best_burgers_area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_title text-center mb-80" id="menu">
                ...
                <c:forEach items="${listBurger}" var="item">
            		<div class="col-md-6 col-lg-6">
	                    <div class="single_delicious d-flex align-items-center">
	                        <div class="thumb">
	                            <img src="<c:url value= "/images/${item.thumbnailName}" />" width="166px" height="166px" alt="">
	                        </div>
	                        <div class="info">
	                            <h3>${item.name}</h3>
	                            <p>${item.ingredient}</p>
	                            <span>${item.price} VND</span>
	                            <c:url value="/them-vao-gio?burgerId=${item.id}" var="addToCart"/>
	                            <a href="${addToCart}" class="boxed-btn3">Add to Cart</a>
	                        </div>
	                    </div>
	                </div>
            	</c:forEach>
...
<!--             <div class="row">
                <div class="col-lg-12">
                    <div class="iteam_links">
                        <a class="boxed-btn5" href="#">More Items</a>
                    </div>
                </div>
            </div> -->
        </div>
            ...
            <div class="Burger_President_here">
                <div class="single_Burger_President">
                    <div class="room_thumb">
                        <img src="<c:url value='/template/web/img/burgers/1.png' />" alt="">
                ...
                <div class="single_Burger_President">
                    <div class="room_thumb">
                        <img src="<c:url value='/template/web/img/burgers/2.png' />" alt="">
                        <div class="room_heading d-flex justify-content-between align-items-center">
                            <div class="room_heading_inner">
                                <span>$20</span>
                                <h3>The Burger President</h3>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="about_thumb2">
                            <div class="img_1">
                                <img src="<c:url value='/template/web/img/about/1.png' />" alt="">
                            </div>
                            <div class="img_2">
                                <img src="<c:url value='/template/web/img/about/2.png' />" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5 offset-lg-1 col-md-6">
                        <div class="about_info" id="about">
                            ...
                            <div class="img_thumb">
                                <img src="<c:url value='/template/web/img/jessica-signature.png' />" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="single_testmonial text-center">
                                                ...
                                                <div class="testmonial_author">
                                                    <div class="thumb">
                                                        <img src="<c:url value='/template/web/img/testmonial/1.png' />" alt="">
                                                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-8">
                                            <div class="single_testmonial text-center">
                                                ...
                                                <div class="testmonial_author">
                                                    <div class="thumb">
                                                        <img src="<c:url value='/template/web/img/testmonial/2.png' />" alt="">
                                                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-8">
                                            <div class="single_testmonial text-center">
                                                ...
                                                <div class="testmonial_author">
                                                    <div class="thumb">
                                                        <img src="<c:url value='/template/web/img/testmonial/3.png' />" alt="">
                                                    </div>
                                                    <h4>A.H Shemanto</h4>
                                                    <div class="stars">
                                                        <i class="fa fa-star"></i>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="single_instagram">
                    <img src="<c:url value='/template/web/img/instragram/1.png' />" alt="">
                    <div class="ovrelay">
                        <a href="#">
                            <i class="fa fa-instagram"></i>
                        </a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single_instagram">
                    <img src="<c:url value='/template/web/img/instragram/2.png' />" alt="">
                    <div class="ovrelay">
                        <a href="#">
                            <i class="fa fa-instagram"></i>
                        </a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single_instagram">
                    <img src="<c:url value='/template/web/img/instragram/3.png' />" alt="">
                    <div class="ovrelay">
                        <a href="#">
                            <i class="fa fa-instagram"></i>
                        </a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single_instagram">
                    <img src="<c:url value='/template/web/img/instragram/4.png' />" alt="">
                    <div class="ovrelay">
                        <a href="#">
                            <i class="fa fa-instagram"></i>
                        </a>
